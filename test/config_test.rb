...
class EdsApiTests < Minitest::Test
  ...
  def test_options_config
    VCR.use_cassette('config_test/profile_1/test_options_config', :allow_playback_repeats => true) do
  ...
  def test_yaml_file_config
    ...
    VCR.use_cassette('config_test/profile_1/test_yaml_file_config', :allow_playback_repeats => true) do
  ...
  def test_yaml_file_bad_syntax
    ...
    VCR.use_cassette('config_test/profile_1/test_yaml_file_bad_syntax', :allow_playback_repeats => true) do
  ...
  def test_yaml_no_file
    VCR.use_cassette('config_test/profile_1/test_yaml_no_file', :record => :new_episodes, :allow_playback_repeats => true) do
      s = EBSCO::EDS::Session.new({use_cache: false, profile: 'edsapi', config: 'eds-test88.yaml'})
